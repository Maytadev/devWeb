...
export default function Footer() {
  return <footer className="wow fadeInUp dark:bg-gray-dark relative z-10 bg-white pt-16 md:pt-20 lg:pt-24" data-wow-delay='.1s'>
    <div className="container">
      ...
      <div className="py-8">
        <p className="text-center text-base text-body-color dark:text-white">
          ...
          <a href="https://upal.edu.pe/" rel="nofollow noopener">Universidad Privada Peruano Alemana</a>
        </p>
      </div>
    </div>
  </footer>
